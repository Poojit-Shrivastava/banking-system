...
import BankingSystem.transaction.TransferRequest;
...
public class AccountController {
    ...
    public ResponseEntity<Account> getAccountById(@PathVariable Integer id, @AuthenticationPrincipal Jwt jwt){
        ...
        boolean owned = accountService.isAccountOwnedByUser(id, username);
        if(!owned){
    ...
    public ResponseEntity<Account> createAccount(@RequestBody AccountRequest request, @AuthenticationPrincipal Jwt jwt) {
